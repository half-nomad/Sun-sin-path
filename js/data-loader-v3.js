...
class SunsinDataLoader {
    constructor() {
        ...
        console.log(`🚀 순신의 길 데이터 로더 v2 초기화 완료 (경로: ${this.baseUrl})`);
    }
    ...
    async loadJsonFile(filename) {
        ...
        try {
            ...
            console.log(`📥 JSON 파일 로드 중: ${filename} (전체 경로: ${fullUrl})`);
...
console.log('✅ data-loader.js v2 로드 완료');
